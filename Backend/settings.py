...
SECRET_KEY = 'kp_n=1c7^5%l3#fp4g1-moj0%(_oyp8!qpa4*x$sg68f9l)(y_'
...
MIDDLEWARE = [
    ...
    'corsheaders.middleware.CorsMiddleware',      # connection with react
...
DEFAULT_AUTO_FIELD = 'django.db.models.BigAutoField'  #add this after showing error
